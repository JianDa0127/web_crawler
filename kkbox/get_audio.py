...
def get_audio(SongType, Area, Lang, Cate, Date):
    ...
    # driver = webdriver.Chrome(chrome_options=options, executable_path="./chromedriver.exe") # Use Chrome
    ...
    # driver.find_element_by_link_text('日榜').click()
    # time.sleep(5)
    # driver.find_element_by_link_text(sn).click()
    # time.sleep(5)
    # driver.find_element_by_partial_link_text('全部試聽').click()
    for i in range(2,53,1):
        ...
        song_name=driver.find_element_by_xpath("/html/body/div[5]/div[2]/div[2]/div[1]/h1")
